...
const TwitterApps = ({
  ...
  Object(external_react_["useEffect"])(() => {
    ...
    dispatch(Object(meta_basePath["b" /* setBasePath */])(basePath));
  }, []);
...
const Page = () => {
  ...
  return mutereminder_jsx(external_react_default.a.Fragment, null, mutereminder_jsx(Common_Header["a" /* default */], null), mutereminder_jsx(templates_TwitterApps, {
    basePath: base_path // appName={TwAppsConst.APPNAME_MUTER}
