...
var requestMutedUsers = function requestMutedUsers(endpoint) {
  ...
  return function (dispatch) {
    ...
    Object(_modules_requestToServer__WEBPACK_IMPORTED_MODULE_1__["default"])(endpoint, params, dispatch).then(function (_ref2) {
      var data = _ref2.data;
...
function (_Component) {
  ...
  _createClass(TwitterApps, [{
    ...
    value: function componentDidMount() {
      var baseUrl = this.props.baseUrl;
      this.props.requestUserInfo(baseUrl + _TwAppsConst__WEBPACK_IMPORTED_MODULE_4__["default"].USER_INFO_ENDPOINT);
    }
  }, {
    key: "render",
    value: function render() {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(function () {
  ...
  requestUserInfo: _MuteReminder_actions__WEBPACK_IMPORTED_MODULE_8__["requestUserInfo"]
})(TwitterApps));
...
/* harmony import */ var _TwApps_components_TwitterApps__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./TwApps/components/TwitterApps */ "./resources/js/TwApps/components/TwitterApps.jsx");
...
if (appElem) {
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_5__["Provider"], {
    store: store
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_TwApps_components_TwitterApps__WEBPACK_IMPORTED_MODULE_8__["default"], {
